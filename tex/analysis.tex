...
Despite that a lot of code from researches are not following and not using design
pattern, it's really simplifies understanding and reasoning about the code, especially
while extending or adjusting the model. Therefore using design patterns
is highly recommended. Below is a list of design pattern recommendations:
